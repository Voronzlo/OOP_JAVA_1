...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Person Vlada = new Person("Влада", 9);
        Person Maksim = new Person("Максим", 10);
        Person Oleg = new Person("Олег", 11);
        Person Sasha = new Person("Саша", 12);
        Person vlad = new Person("Влад", 3);
        ...
        gt.appendPerentChild(igor, vlad); // Игорь родитель Влада
        gt.appendPerentChild(igor, Maksim); // Игорь родитель Максима
        gt.appendPerentChild(igor, Oleg); // Игорь родитель Олега
        gt.appendPerentChild(igor, Vlada); // Игорь родитель Влада 
